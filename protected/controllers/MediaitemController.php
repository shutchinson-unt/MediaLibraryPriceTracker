...
class MediaitemController extends Controller
{
    ...
    {
        $dataProvider=new CActiveDataProvider('MediaItem');
    ...
    {
        $model=new MediaItem('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['MediaItem']))
            $model->attributes=$_GET['MediaItem'];
     ...
     * @return MediaItem the loaded model
     ...
     * @param MediaItem $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if(isset($_POST['ajax']) && $_POST['ajax']==='media-item-form')
        {
